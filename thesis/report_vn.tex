...
Khóa luận này đánh giá bốn kiến trúc học sâu --- EfficientNet-B0, ResNet50, DenseNet121 và Swin-Tiny --- trong cùng một pipeline huấn luyện được thiết kế để đối phó với sự mất cân bằng đó. Pipeline kết hợp Lấy mẫu Ngẫu nhiên có Trọng số, tăng cường dữ liệu Mixup và CutMix, làm mượt nhãn, và tối ưu hóa AdamW với lịch trình cosine. Trong bốn mô hình, EfficientNet-B0 cho kết quả đơn lẻ tốt nhất: độ chính xác 88,36\% và chỉ số Macro F1 đạt 0,831, mặc dù có ít tham số hơn bất kỳ kiến trúc cạnh tranh nào. Phương pháp kết hợp biểu quyết mềm (soft-voting ensemble) của cả bốn mạng đã cải thiện hiệu suất lên 89,49\% độ chính xác và 0,980 Macro AUC. Trực quan hóa Grad-CAM xác nhận rằng mọi mô hình đều tập trung vào vùng tổn thương thay vì vùng da xung quanh hoặc nhiễu ảnh. Nghiên cứu loại bỏ thành phần (ablation study) xác định Mixup và CutMix là thành phần huấn luyện quan trọng nhất, với việc loại bỏ chúng gây ra sụt giảm 4,5 điểm phần trăm trong Macro F1.
