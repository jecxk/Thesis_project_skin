...
\begin{itemize}[leftmargin=*]
  \item Mô hình đơn tốt nhất: EfficientNet-B0 --- Accuracy 88.36\%, Macro F1 0.831.
  \item \textbf{Ensemble} (soft voting 4 mô hình): Accuracy 89.49\%, Macro F1 0.845, AUC 0.980.
\end{itemize}
...
\rowcolor{usthblue!10}
\textbf{Đồ án này}    & 2026 & \textbf{4-model soft ensemble} & \textbf{89.49} & \textbf{0.845} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Ensemble} bằng soft voting (trung bình xác suất 4 mô hình) $\Rightarrow$ Accuracy 89.49\%, Macro F1 0.845, AUC 0.980.
