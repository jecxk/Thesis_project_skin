...
\begin{frame}{Phương pháp}
    ...
    \begin{columns}[T]
        ...
        \begin{block}{Tiền xử lý (mọi tập)}
            ...
            \begin{itemize}
                ...
                \item Chia stratified $70/15/15$ --- train/val/test giữ đúng tỷ lệ các lớp.
            \end{itemize}
        \end{block}

        \column{0.5\textwidth}
        \begin{block}{Tăng cường dữ liệu (chỉ tập train, online)}
            \footnotesize
            \begin{itemize}
    ...
    \begin{figure}
        \centering
        \includegraphics[height=4.1cm,keepaspectratio]{../thesis/figures/augmentation_examples.png}
    \end{figure}
\end{frame}
...
\begin{frame}{Phương pháp}
    ...
    \footnotesize
    Cả 4 mô hình đều \textbf{fine-tune từ ImageNet pretrained} qua thư viện \texttt{timm}; việc trộn CNN và Transformer giúp ensemble khai thác \textbf{lỗi không tương quan}.

    \begin{figure}
        \centering
        \includegraphics[height=3.0cm,keepaspectratio]{../thesis/figures_new/training_loss_all_models.png}
