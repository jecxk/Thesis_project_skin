...
\begin{frame}{A26. So sánh ma trận nhầm lẫn --- Bốn backbone}
    ...
    \end{columns}
    \vspace{0.15cm}
    \scriptsize \textit{Cả bốn mô hình đều có cùng kiểu lỗi --- nhầm lẫn trong cụm \textbf{MEL $\leftrightarrow$ NV $\leftrightarrow$ BKL} --- nhưng mỗi mô hình sai theo cách khác nhau, và đó chính là lý do soft-voting ensemble vượt mọi mô hình đơn lẻ.}
\end{frame}
