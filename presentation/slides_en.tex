...
\begin{frame}{Methodology}
    ...
    \begin{columns}[T]
        ...
        \begin{block}{Preprocessing (all splits)}
            ...
            \begin{itemize}
                ...
                \item Stratified $70/15/15$ split --- train/val/test keep the same class ratios.
            \end{itemize}
        \end{block}

        \column{0.5\textwidth}
        \begin{block}{Augmentation (train only, online)}
            \footnotesize
            \begin{itemize}
    ...
    \begin{figure}
        \centering
        \includegraphics[height=4.0cm,keepaspectratio]{../thesis/figures/augmentation_examples.png}
    \end{figure}
\end{frame}
...
\begin{frame}{Methodology}
    ...
    \footnotesize
    All four are \textbf{fine-tuned from ImageNet pretrained weights} via \texttt{timm}; the diverse mix of CNNs and Transformer gives the ensemble \textbf{uncorrelated errors} to exploit.
